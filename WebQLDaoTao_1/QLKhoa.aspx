<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QLKhoa.aspx.cs" Inherits="WebQLDaoTao_1.QLKhoa" %>
...
<asp:ObjectDataSource ID="ods_Khoa" runat="server"
    TypeName="WebQLDaoTao_1.Models.KhoaDAO"
    DataObjectTypeName="WebQLDaoTao_1.Models.Khoa"
    SelectMethod="getAll"   
    InsertMethod="Insert"
    UpdateMethod="Update"
    DeleteMethod="Delete">
